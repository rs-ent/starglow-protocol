...
export async function runCronTweetScheduler() {
  ...
  const csvUrl =
    "https://docs.google.com/spreadsheets/d/e/2PACX-1vS7-XHjG1woLDYK1sUNEUmWUgormRv5GAckf9BS4LAuXcVoj_tA9jvBmhbr2FW8BGn6Lcarhlc3D6tV/pub?gid=2862463&single=true&output=csv";
  ...
  for (let i = 0; i < lines.length; i++) {
    const { schedule_id, poll_id, scheduled_at, text, image_url, status } =
      lines[i];
    console.log(lines[i]);
    console.log("====================");
