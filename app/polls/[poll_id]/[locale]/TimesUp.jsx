...
export default function TimesUp({ t, poll }) {
  return (
    <div className="m-4 p-2 flex flex-col min-h-screen items-center justify-center">
      <div className="relative items-center justify-center">
        ...
        <h1 className="text-center text-5xl text-outline-1">00:00:00</h1>
      ...
      <a href="/polls" rel="noreferrer" className="button-base mt-16">
        <Image
