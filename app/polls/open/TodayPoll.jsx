...
export default function TodaySong({ poll_id, songIdx = "0" }) {
  ...
  const title = poll.title_shorten || poll.title;
  ...
  useEffect(() => {
    function handleResize() {
      ...
      const newFontSize = Math.max(
        75,
        Math.min(width / (title.length * 0.35), 90)
      );
  ...
  return (
    <div className="today-poll-wrapper">
      <div className="text-center">
        ...
        <div
          className="w-[98vw] flex justify-center mx-auto mt-6 mb-14 px-4 py-2"
          ref={containerRef}
        >
          <div
            style={{
          ...
          >
            <p
              className="text-outline-5-purple-glassblack text-center font-main-bold"
              style={{ fontSize }}
            >
              {title.toUpperCase()}
            </p>
        ...
        <div className="flex flex-col justify-center items-center">
          <div className="w-[48vw]">
            <div className="relative">
              ...
              {img && (
                <div
                  className="aspect-[2.0625/1] p-[1.2px]
                                    rounded-[15px]
          ...
          <div className="flex justify-center items-center mt-8 w-[80vw]">
            <Textfit mode="single" className="w-[90%] my-2" max={36} min={28}>
